...
#   Character.create(name: "Luke", movie: movies.first)
  ...
  sixth_post = Post.create!(author: second_user, title: 'Hello', text: 'This is my sixth post')
  ...
  Comment.create!(post: fifth_post, author: second_user, text: 'Hi Tom!' )
  Comment.create!(post: fifth_post, author: first_user, text: 'Hi Lilly!' )
  Comment.create!(post: sixth_post, author: second_user, text: 'Hi Tom!' )
  Comment.create!(post: sixth_post, author: first_user, text: 'Hi Lilly!' )
